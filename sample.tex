\documentclass[compress,12pt,handout]{beamer}
\usetheme{ucl}
...
\useoutertheme[title+headline]{ucltitlebanner}

%%% Gives block elements (theorems, examples) a round, shaded border
\useinnertheme{blockrounded}
...
\titlegraphic{%
  \includegraphics[height=0.08\paperwidth]{logos/EPSRC}%
  \hspace{0.5cm}%
  \includegraphics[height=0.08\paperwidth]{logos/GIFTSurg}%
  \hspace{0.5cm}%
  \includegraphics[height=0.08\paperwidth]{logos/EPSRC_CDT}%
  }
...
\logo{%
  \includegraphics[width=0.12\paperwidth]{logos/GIFTSurg}}
