...
%%% Change to black background with white foreground text color
\usebackgroundtemplate%
{%
    \includegraphics[width=\paperwidth,height=\paperheight]{UCL-Beamer/backgrounds/background_black}%
}
\setbeamercolor{normal text}{fg=white}\usebeamercolor*{normal text}


\begin{frame}
    %%% Change title page to have non-shaded background and offset it for correct alignment
    \vspace*{1cm}
